...
from sqala_python_sdk.model.qr_code_list_all_response import QrCodeListAllResponse as QrCodeListAllResponseSchema

from sqala_python_sdk.type.qr_code_list_all_response import QrCodeListAllResponse

from ...api_client import Dictionary
from sqala_python_sdk.pydantic.qr_code_list_all_response import QrCodeListAllResponse as QrCodeListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = QrCodeListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: QrCodeListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return QrCodeListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(QrCodeListAllResponsePydantic, raw_response.body)
