...
from sqala_python_sdk.model.itp_list_all_response import ItpListAllResponse as ItpListAllResponseSchema

from sqala_python_sdk.type.itp_list_all_response import ItpListAllResponse

from ...api_client import Dictionary
from sqala_python_sdk.pydantic.itp_list_all_response import ItpListAllResponse as ItpListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ItpListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ItpListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return ItpListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ItpListAllResponsePydantic, raw_response.body)
