...
class BaseApi(api_client.Api):
    ...
    def _list_transactions_mapped_args(
        self,
        recipient_id: str,
    ...
    async def _alist_transactions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/recipients/{recipientId}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListTransactionsRaw(BaseApi):
    ...
    async def alist_transactions(
        ...
        **kwargs,
        ...
        args = self._list_transactions_mapped_args(
            recipient_id=recipient_id,
            limit=limit,
            before=before,
            after=after,
        )
        return await self._alist_transactions_oapg(
...
class ListTransactions(BaseApi):
    ...
    async def alist_transactions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_transactions(
            recipient_id=recipient_id,
            limit=limit,
            before=before,
            after=after,
    ...
    def list_transactions(
        ...
        raw_response = self.raw.list_transactions(
            recipient_id=recipient_id,
            limit=limit,
            before=before,
            after=after,
