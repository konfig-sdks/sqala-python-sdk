...
class BaseApi(api_client.Api):
    ...
    def _list_all_bank_transfers_mapped_args(
        self,
    ...
    async def _alist_all_bank_transfers_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/bank-transfer-payments',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_all_bank_transfers_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAllBankTransfersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_bank_transfers(
        self,
        limit: typing.Optional[str] = None,
        before: typing.Optional[str] = None,
        after: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_all_bank_transfers_mapped_args(
            limit=limit,
            before=before,
            after=after,
        )
        return await self._alist_all_bank_transfers_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_all_bank_transfers(
        self,
        limit: typing.Optional[str] = None,
        before: typing.Optional[str] = None,
        after: typing.Optional[str] = None,
        ...
        return self._list_all_bank_transfers_oapg(
            query_params=args.query,
        )

class ListAllBankTransfers(BaseApi):
    ...
    async def alist_all_bank_transfers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_all_bank_transfers(
            limit=limit,
            before=before,
            after=after,
            **kwargs,
    ...
    def list_all_bank_transfers(
        ...
        raw_response = self.raw.list_all_bank_transfers(
            limit=limit,
            before=before,
            after=after,
        )
