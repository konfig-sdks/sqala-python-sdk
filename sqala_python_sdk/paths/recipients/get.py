...
from sqala_python_sdk.model.recipient_list_all_response import RecipientListAllResponse as RecipientListAllResponseSchema

from sqala_python_sdk.type.recipient_list_all_response import RecipientListAllResponse

from ...api_client import Dictionary
from sqala_python_sdk.pydantic.recipient_list_all_response import RecipientListAllResponse as RecipientListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = RecipientListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RecipientListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RecipientListAllResponsePydantic:
        ...
        if validate:
            return RecipientListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RecipientListAllResponsePydantic, raw_response.body)
