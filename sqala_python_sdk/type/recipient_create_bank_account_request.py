...
class RequiredRecipientCreateBankAccountRequest(TypedDict):
...
class OptionalRecipientCreateBankAccountRequest(TypedDict, total=False):
    # The type of bank account. Can be CHEKING or SAVINGS.
    type: str

class RecipientCreateBankAccountRequest(RequiredRecipientCreateBankAccountRequest, OptionalRecipientCreateBankAccountRequest):
    pass
