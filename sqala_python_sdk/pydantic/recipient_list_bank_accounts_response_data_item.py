...
from sqala_python_sdk.pydantic.recipient_list_bank_accounts_response_data_item_metadata import RecipientListBankAccountsResponseDataItemMetadata

class RecipientListBankAccountsResponseDataItem(BaseModel):
    ...
    metadata: typing.Optional[RecipientListBankAccountsResponseDataItemMetadata] = Field(None, alias='metadata')
