...
from sqala_python_sdk.pydantic.recipient_get_bank_account_response_metadata import RecipientGetBankAccountResponseMetadata

class RecipientGetBankAccountResponse(BaseModel):
    ...
    metadata: typing.Optional[RecipientGetBankAccountResponseMetadata] = Field(None, alias='metadata')
