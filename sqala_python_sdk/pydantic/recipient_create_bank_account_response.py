...
from sqala_python_sdk.pydantic.recipient_create_bank_account_response_metadata import RecipientCreateBankAccountResponseMetadata

class RecipientCreateBankAccountResponse(BaseModel):
    ...
    metadata: typing.Optional[RecipientCreateBankAccountResponseMetadata] = Field(None, alias='metadata')
