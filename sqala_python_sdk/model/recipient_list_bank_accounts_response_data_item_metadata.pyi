...
class RecipientListBankAccountsResponseDataItemMetadata(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CUSTOM_FIELD_NAME", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CUSTOM_FIELD_NAME", ], str]):
    ...
    ) -> 'RecipientListBankAccountsResponseDataItemMetadata':
