...
class QrCodeListAllResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payer() -> typing.Type['QrCodeListAllResponseDataItemPayer']:
                return QrCodeListAllResponseDataItemPayer
        
            @staticmethod
            def split() -> typing.Type['QrCodeListAllResponseDataItemSplit']:
                return QrCodeListAllResponseDataItemSplit
            ...
            @staticmethod
            def metadata() -> typing.Type['QrCodeListAllResponseDataItemMetadata']:
                return QrCodeListAllResponseDataItemMetadata
            __annotations__ = {
                "id": id,
                "code": code,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payer"]) -> 'QrCodeListAllResponseDataItemPayer': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["split"]) -> 'QrCodeListAllResponseDataItemSplit': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'QrCodeListAllResponseDataItemMetadata': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payer"]) -> typing.Union['QrCodeListAllResponseDataItemPayer', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["split"]) -> typing.Union['QrCodeListAllResponseDataItemSplit', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['QrCodeListAllResponseDataItemMetadata', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payer: typing.Union['QrCodeListAllResponseDataItemPayer', schemas.Unset] = schemas.unset,
        split: typing.Union['QrCodeListAllResponseDataItemSplit', schemas.Unset] = schemas.unset,
        ...
        metadata: typing.Union['QrCodeListAllResponseDataItemMetadata', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'QrCodeListAllResponseDataItem':
