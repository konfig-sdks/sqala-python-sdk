...
class QrCodeGetQrCodeByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payer() -> typing.Type['QrCodeGetQrCodeByIdResponsePayer']:
                return QrCodeGetQrCodeByIdResponsePayer
        
            @staticmethod
            def split() -> typing.Type['QrCodeGetQrCodeByIdResponseSplit']:
                return QrCodeGetQrCodeByIdResponseSplit
            ...
            @staticmethod
            def metadata() -> typing.Type['QrCodeGetQrCodeByIdResponseMetadata']:
                return QrCodeGetQrCodeByIdResponseMetadata
            __annotations__ = {
                "id": id,
                "code": code,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payer"]) -> 'QrCodeGetQrCodeByIdResponsePayer': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["split"]) -> 'QrCodeGetQrCodeByIdResponseSplit': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'QrCodeGetQrCodeByIdResponseMetadata': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payer"]) -> typing.Union['QrCodeGetQrCodeByIdResponsePayer', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["split"]) -> typing.Union['QrCodeGetQrCodeByIdResponseSplit', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['QrCodeGetQrCodeByIdResponseMetadata', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payer: typing.Union['QrCodeGetQrCodeByIdResponsePayer', schemas.Unset] = schemas.unset,
        split: typing.Union['QrCodeGetQrCodeByIdResponseSplit', schemas.Unset] = schemas.unset,
        ...
        metadata: typing.Union['QrCodeGetQrCodeByIdResponseMetadata', schemas.Unset] = schemas.unset,
