...
class ItpCreatePaymentInstructionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payer() -> typing.Type['ItpCreatePaymentInstructionResponsePayer']:
                return ItpCreatePaymentInstructionResponsePayer
        
            @staticmethod
            def split() -> typing.Type['ItpCreatePaymentInstructionResponseSplit']:
                return ItpCreatePaymentInstructionResponseSplit
            ...
            @staticmethod
            def metadata() -> typing.Type['ItpCreatePaymentInstructionResponseMetadata']:
                return ItpCreatePaymentInstructionResponseMetadata
            __annotations__ = {
                "id": id,
                "code": code,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payer"]) -> 'ItpCreatePaymentInstructionResponsePayer': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["split"]) -> 'ItpCreatePaymentInstructionResponseSplit': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'ItpCreatePaymentInstructionResponseMetadata': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payer"]) -> typing.Union['ItpCreatePaymentInstructionResponsePayer', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["split"]) -> typing.Union['ItpCreatePaymentInstructionResponseSplit', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['ItpCreatePaymentInstructionResponseMetadata', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payer: typing.Union['ItpCreatePaymentInstructionResponsePayer', schemas.Unset] = schemas.unset,
        split: typing.Union['ItpCreatePaymentInstructionResponseSplit', schemas.Unset] = schemas.unset,
        ...
        metadata: typing.Union['ItpCreatePaymentInstructionResponseMetadata', schemas.Unset] = schemas.unset,
