...
class QrCodeGenerateQrCodeResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payer() -> typing.Type['QrCodeGenerateQrCodeResponsePayer']:
                return QrCodeGenerateQrCodeResponsePayer
        
            @staticmethod
            def split() -> typing.Type['QrCodeGenerateQrCodeResponseSplit']:
                return QrCodeGenerateQrCodeResponseSplit
            ...
            @staticmethod
            def metadata() -> typing.Type['QrCodeGenerateQrCodeResponseMetadata']:
                return QrCodeGenerateQrCodeResponseMetadata
            __annotations__ = {
                "id": id,
                "code": code,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payer"]) -> 'QrCodeGenerateQrCodeResponsePayer': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["split"]) -> 'QrCodeGenerateQrCodeResponseSplit': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'QrCodeGenerateQrCodeResponseMetadata': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payer"]) -> typing.Union['QrCodeGenerateQrCodeResponsePayer', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["split"]) -> typing.Union['QrCodeGenerateQrCodeResponseSplit', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['QrCodeGenerateQrCodeResponseMetadata', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payer: typing.Union['QrCodeGenerateQrCodeResponsePayer', schemas.Unset] = schemas.unset,
        split: typing.Union['QrCodeGenerateQrCodeResponseSplit', schemas.Unset] = schemas.unset,
        ...
        metadata: typing.Union['QrCodeGenerateQrCodeResponseMetadata', schemas.Unset] = schemas.unset,
